...
import { Calculator, ArrowRight, Loader2, TrendingUp, AlertTriangle, CheckCircle2 } from "lucide-react";
        ...
        <div className="flex items-start gap-2 rounded-lg bg-amber-500/10 border border-amber-500/20 p-3">
          ...
          <div>
            ...
            <p className="text-xs text-amber-400/70 mt-0.5">
              Amount of {formatSAR(estimatedAmount)} exceeds automatic approval threshold.
            </p>
          </div>
        </div>
      )}
  ...
  return (
    ...
    >
      ...
      <CardContent className="space-y-4">
        <div>
          <Label className="text-xs mb-1.5 block">Estimated procedure cost (SAR)</Label>
